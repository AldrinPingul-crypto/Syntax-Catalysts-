									...
									<?php
										...
										if (isset($_POST['submit'])) {
											...
											if($status != false) {
												...
												$mail->SMTPAuth = true;
												$mail->Username = 'notifications.smdppbacoor@gmail.com';
                                				$mail->Password = 'nqev kuah gfrj odiz';
												...
												$mail->isHTML(true);
												$mail->setFrom("notifications.smdppbacoor@gmail.com", 'Barangay Pitogo');
												$mail->addAddress($_POST['email']);
												$mail->Subject = 'Forgot Password Verification Code - Please take action';
												$mail->Body = "
												<html>
												<head>
												  <style>
												...
												<body>
												  <div class='container'>
												    ...
												    <div class='code-box'>$verification_key</div>
												    <p>
												      You can enter the code with or without spaces.<br><br>
												      If you didn't make this request, you can safely ignore this email. Someone else might have typed your email address by mistake.
												    </p>
												    <div class='footer'>
												      Thank you,<br>
												      <strong>Barangay Pitogo</strong>
												    </div>
												  </div>
												</body>
												</html>";
