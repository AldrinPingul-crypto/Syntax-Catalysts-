						    ...
						    <form class="" method="POST" enctype="multipart/form-data">
	                                <div class="row">
														...
														<div class="form-group col-10">
														    <i>
															Please be informed that your registration to Barangay Pitogo portal will be reviewed. We will notify you via email regarding your account status.</i>
														</div>
									...
									if (isset($_POST['add_resident'])) {
										...
										$digits_hash = password_hash($_POST['password'], PASSWORD_DEFAULT);
											...
											$result = $model->addResidentRegister($address3, $bplace, $occupation, $fname, $mname, $lname, $bdate, $gender, $civil_status, $address1, $address2, $res_since, $date, $resident_status, $contact, $email, $digits_hash, $income, $family, $precinct, $special_status, "");
