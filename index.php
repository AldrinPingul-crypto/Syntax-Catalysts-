                ...
                <div class="container clearfix">
                    ...
                    <div class="secondary-menu">
                        <div class="secondary-inner">
                            ...
                            ?>
                            <a href="residents.php" style="color: white;"><img src="assets/images/resident-picture/<?php echo $prof_pic; ?>" style="width: 23px; height: 23px; border-radius: 50%;object-fit: cover;" alt="User">
                            <?php echo $r_fname; ?> <?php echo $r_lname; ?></a>
                            <?php 
                            }
                            ?>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="mainText tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									BRGY. <span style="color: <?php echo $primary_color; ?>">PITOGO</span>
							</div>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<span style="font-size: 23px;">GANITO KAMI SA MAKATI</span> 
							</div>
					...
					<div class="row">
						<div class="col-lg-7 col-md-12">
							<div class="container2">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7723.472785402134!2d121.03795187770996!3d14.557061399999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c8f70ad5a387%3A0xf79799d3f1202b7f!2sPitogo%20Barangay%20Hall%20-%20Taguig!5e0!3m2!1sen!2sph!4v1758196432242!5m2!1sen!2sph" class="responsive-iframe" loading="lazy"></iframe>
							</div>
						</div>
