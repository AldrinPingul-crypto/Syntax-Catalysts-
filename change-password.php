							...
							<div class="row placeani">
								<div class="col-lg-12">
									<?php 
										...
										if (!empty($rows)) {
											foreach ($rows as $row) {
												$prof_pic = !empty($row['prof_pic']) ? $row['prof_pic'] : 'default.jpg';
									?>
									<div class="form-group user-info">
									    <a href="residents.php" class="user-link">
									        <img src="assets/images/resident-picture/<?php echo $prof_pic; ?>" alt="User">
									        <div class="user-text">
