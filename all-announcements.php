								...
								<div class="event-bx m-b30">
									...
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											...
											<ul class="media-post">
												<li><a href="#"><i class="fa fa-clock-o"></i> <?php echo date('M. d, Y', strtotime($row['date'])); ?></a></li>
											</ul>
											<p><?php echo substr($row['details'], 0, 150); ?><a href="announcement-details?id=<?php echo $row['id']; ?>" style="color: #0d60aa;">.... See More</a></p>
										</div>
									</div>
								</div>
							</li>
