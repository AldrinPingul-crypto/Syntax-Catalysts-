						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="profile-bx text-center"style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
								<div class="user-thumb">
									<img src="assets/images/org-structure/<?php echo $brgy_head_pic; ?>.jpg" style="width: 250px; height: 320px;object-fit: cover;">	
								</div>
													...
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 <?php echo $row['position']; ?>">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/<?php echo $row['image_unique']; ?>.jpg" style="width: 250px; height: 260px;object-fit: cover;">	
															</div>
